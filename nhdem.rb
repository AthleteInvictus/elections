...
poll = Poll.where(:chart => '2016-new-hampshire-presidential-democratic-caucus').first
responses = poll.questions.detect { |question| question.chart == '2016-new-hampshire-presidential-democratic-caucus' }.responses
