...
poll = Poll.where(:chart => '2016-florida-presidential-republican-primary').first
responses = poll.questions.detect { |question| question.chart == '2016-florida-presidential-republican-primary' }.responses
...
runcsv = File.open("csv/floridagop.csv", "w+")
